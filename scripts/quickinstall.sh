...
wget -O /etc/systemd/system/cloud-torrent.service https://raw.githubusercontent.com/imgload/simple-torrent/master/scripts/cloud-torrent.service
...
Read the wiki page about changing the default settings.
    https://github.com/imgload/simple-torrent/wiki/AuthSecurity
