...
function install {
	#settings
	BASE_URL="https://github.com/imgload/simple-torrent"
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"darwin_amd64")
		URL="https://github.com/imgload/simple-torrent/releases/download/$LATEST_TAG/cloud-torrent_linux_amd64.gz"
		FTYPE=".gz"
		;;
	"linux_386")
		URL="https://github.com/imgload/simple-torrent/releases/download/$LATEST_TAG/cloud-torrent_linux_386.gz"
		FTYPE=".gz"
		;;
	"linux_amd64")
		URL="https://github.com/imgload/simple-torrent/releases/download/$LATEST_TAG/cloud-torrent_linux_amd64.gz"
		...
		;;
	"linux_arm")
		URL="https://github.com/imgload/simple-torrent/releases/download/$LATEST_TAG/cloud-torrent_linux_arm.gz"
		FTYPE=".gz"
		;;
